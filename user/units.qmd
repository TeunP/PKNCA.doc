...
```r
args(pknca_units_table)
# function(concu, doseu, amountu, timeu,
#          concu_pref = NULL, doseu_pref = NULL,
#          amountu_pref = NULL, timeu_pref = NULL,
...
Pass the table via the `units` argument. If `units` is provided, any units
given directly to `PKNCAconc()` or `PKNCAdose()` are ignored.
