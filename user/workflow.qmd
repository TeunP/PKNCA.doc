...
| `hl_method` | `"log-linear"` | `"log-linear"` or `"tobit"` — **not in CRAN 0.12.1, requires GitHub version** |
| `tobit_n_points_penalty` | `0` | Extra penalty per point in tobit — **GitHub version only** |
