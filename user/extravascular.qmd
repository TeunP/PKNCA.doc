...
> **Note:** There is no `first.tmin` option in PKNCA 0.12.1. The Cmin value returned is always the minimum concentration in the interval; tie-breaking is not configurable.
